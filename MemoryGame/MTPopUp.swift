...
//        self.addGestureRecognizer(panGesture)
        ...
        viewHeaderPopup.backgroundColor = AppDelegate.constants.themeColor//UIColor(red: 37.0/255.0, green: 188.0/255.0, blue: 126.0/255.0, alpha: 1)
...
//MARK: - Show Popup
    func show(complete : ((Int)->())? , view: UIView,animationType: NSString,strMessage: String,btnArray: NSArray,strTitle: String = "")
    {
        ...
        for strBtnTitle in btnArray
        {
            ...
            btnOk.backgroundColor = AppDelegate.constants.themeColor//UIColor(red: 37.0/255.0, green: 188.0/255.0, blue: 126.0/255.0, alpha: 1)
